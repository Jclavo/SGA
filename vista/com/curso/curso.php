...
<html lang="en">
    ...
    <body>
            ...
            <div class="panel-body">
                <form id="formCurso" class="form-horizontal" role="form">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputPassword1" class="col-lg-2 control-label">Pre-requisito</label>
                                <div class="col-lg-10">
                                    <select id="cboPrerequisito" class="select2">
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">Creditos</label>
                                <div class="col-lg-10">
                                    <input type="number" class="form-control" id="txtCredito" maxlength="50">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="inputPassword1" class="col-lg-2 control-label">Ciclo</label>
                                <div class="col-lg-10">
                                    <select id="cboCiclo" class="select2">
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <button type="submit" class="btn btn-info" onclick="agregarCurso()">Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style='text-align:center;'>Pre-requisito</th>
        ...
        <script type="text/javascript" src="<?php echo Configuraciones::URL_BASE ?>vista/com/curso/curso.js"></script>
