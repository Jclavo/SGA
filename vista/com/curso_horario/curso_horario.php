...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select id="cboHorario" class="select2">
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                                <button type="submit" class="btn btn-info" onclick="agregarCursoHorario()">Guardar</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript" src="<?php echo Configuraciones::URL_BASE ?>vista/com/curso_horario/curso_horario.js"></script>
